...
class contenedorMongoDb{
    ...
    async save(objeto){
            try {
                ...
                const user = {nombre: objeto.nombre, contrasena: objeto.contrasena, cantidad: [], telefono: objeto.telefono, email: objeto.email, direccion: objeto.direccion, edad: objeto.edad, foto: objeto.foto, mayoriaDeEdad: objeto.mayoriaDeEdad, codigoSecreto: objeto.codigoSecreto};
